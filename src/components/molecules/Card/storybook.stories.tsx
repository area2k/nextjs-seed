...
import CardComponent, { Props } from '@/components/molecules/Card'
  ...
  >
    <CardComponent.Section>
      <div className="flex flex-col">
        <p>Andrew Rempe</p>
        <small className="text-lo">arempe@area2k.com</small>
      </div>
    </CardComponent.Section>
    <CardComponent.Section
      actions={[
    ...
    >
      <div className="flex flex-col">
        ...
        <p className="text-lo">APT 413</p>
        <small className="text-lo">Dallas, TX 75531</small>
      </div>
    </CardComponent.Section>
  </CardComponent>
)
